...
@interface YBPlayerNotification ()

@property (nonatomic, assign) YBPlayerBackgroundState backgroundState;

@end

@implementation YBPlayerNotification
...
- (void)applicationWillResignActiveNotification {
    self.backgroundState = YBPlayerBackgroundStateBackground;
    if (_willResignActive) _willResignActive(self);
}

- (void)applicationDidBecomeActiveNotification {
    self.backgroundState = YBPlayerBackgroundStateForeground;
